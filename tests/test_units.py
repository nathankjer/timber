...
class TestUnitSystemManager:
    ...
    def test_get_preferred_units_metric(self):
        ...
        assert (
            manager.get_preferred_unit("moment_of_inertia")
            == Units.MILLIMETER_TO_FOURTH
        )
        assert (
            manager.get_preferred_unit("acceleration") == Units.METER_PER_SECOND_SQUARED
        )
    ...
    def test_get_preferred_units_imperial(self):
        ...
        assert (
            manager.get_preferred_unit("acceleration") == Units.FOOT_PER_SECOND_SQUARED
        )
